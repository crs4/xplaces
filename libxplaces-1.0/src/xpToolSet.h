...
#define SESSION_STRING 32, true, false, false
...
//	static void debugOutput(std::vector<struct property >);
	...
	*/
    ...
    inline static u_int16_t toStdEndianess(u_int16_t value) {
	...
	*/
    ...
    inline static u_int16_t toLocalEndianess(u_int16_t value) {
        if (testBigEndian() == false) {
            return value;
        } else {
            u_int16_t retVal;
