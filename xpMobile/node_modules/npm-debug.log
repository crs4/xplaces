...
5 error package.json ENOENT, open '/code/sources/xplaces/xpMobile/package.json'
...
7 error command "/opt/local/bin/node" "/opt/local/bin/npm" "install"
8 error cwd /code/sources/xplaces/xpMobile/node_modules
9 error node -v v0.10.28
10 error npm -v 1.4.13
11 error path /code/sources/xplaces/xpMobile/package.json
