...
function localNodeIsServer()
{
	var serverIP = appEnviroment.netconf.serverIPPort.split(":")[1].substr(2);
	var serverPort = appEnviroment.netconf.serverIPPort.split(":")[2];
	
	if(appEnviroment.netconf.localIP == serverIP && appEnviroment.netconf.basePort == serverPort)
		return true;
...
function datagramToHash(datagram) {
	...
	while(offset < datagram.length) {
		...
		offset += valueSize;
		//xpLog(false, key + " " + value + " " + numCouples);
...
exports.localNodeIsServer = localNodeIsServer
exports.getAppEnviroment = getAppEnviroment